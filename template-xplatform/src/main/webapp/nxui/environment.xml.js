if (nexacro.Environment)
{
    ...
    {
        this.set_themeid("theme::nps");
        this.set_filesecurelevel("all");
        this.set_scrollindicatorsize("5");
        this.set_userfontid("font::nps.xfont");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("svcurl", "JSP", "http://localhost:8080/xp/xplatform/", "none", null, "", "0", "0");
        nexacro._addService("xeni", "JSP", "http://14.63.225.189:9418/nps/", "none", null, "", "0", "0");
        nexacro._addService("npsLib", "file", "./_extlib_/npsLib/", "session", null, "", "0", "0");
