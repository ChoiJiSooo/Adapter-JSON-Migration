(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_background("#f5f5f5");
            this.set_scrollbartype("none none");
            if (Form == this.constructor)
            {
                this._setFormPosition(1024,40);
            }
            ...
            obj = new Div("divButtonList","0","1",null,"57","240",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Button("btnCloseAll",null,"3","17",null,"22","0",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("btn_MDI_ScnClose");
            obj.set_enable("true");
            this.addChild(obj.name, obj);

            obj = new Button("btnVertical",null,"3","17",null,"btnCloseAll:10","0",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("btn_MDI_ScnHDiv");
            obj.set_enable("true");
            this.addChild(obj.name, obj);

            obj = new Button("btnHorizontal",null,"3","18",null,"btnVertical:10","0",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("btn_MDI_ScnVDiv");
            obj.set_enable("true");
            this.addChild(obj.name, obj);

            obj = new Button("btnCascade",null,"3","19",null,"btnHorizontal:10","0",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("btn_MDI_ScnWin");
            obj.set_enable("true");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Button("btnMaximize",null,"3","19",null,"btnCascade:10","0",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_enable("true");
            obj.set_cssclass("btn_MDI_ScnFull");
            this.addChild(obj.name, obj);

            obj = new Static("Static00",null,"11","1","20","btnMaximize:10",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_background("#e5e5e5");
            this.addChild(obj.name, obj);

            obj = new Button("btnMdiNext",null,"3","19",null,"Static00:15","0",null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_cssclass("btn_MDI_RightTabCha");
            obj.set_enable("false");
            this.addChild(obj.name, obj);

            obj = new Button("btnMdiPrev",null,"3","19",null,"btnMdiNext:10","0",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_cssclass("btn_MDI_LeftTabCha");
            obj.set_enable("false");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this.divButtonList.form
            obj = new Layout("default","",0,0,this.divButtonList.form,function(p){});
            this.divButtonList.form.addLayout(obj.name, obj);

            //-- Default Layout : this
            obj = new Layout("default","",1024,40,this,function(p){});
        ...
        */
        this.fnCreateTab = function(menuId, menuNm)
        {
        	...
        	var objDiv = new Div();
        		...
        		objDiv.init(sMenuId, nLeft, 0, this.fvTabButtonSize, 40);
        ...
        */
        ...
        this.fnSetTabFocus = function(divNm)
        {
        	...
        	if(this.gfnIsNull(objDiv))
        	{
        		...
        		var menuNm = objApp.gdsMenu.getColumn(objApp.gdsMenu.findRow(CONST_MENU_ID, menuId), CONST_MENU_NM);
        ...
        */
        this.btnMaximize_onclick = function(obj,e)
        {
        	...
        	for(var i = 0; i < workFrame.frames.length ; i++)
        	{
        		...
        		workFrame.frames[i].form.divWork.set_left(6);
        ...
        this.btnArrange_onclick = function(obj,e)
        {
        	...
        	{
        		workFrame.frames[i].set_enableevent(false);
        		workFrame.frames[i].form.divWork.set_left(20);
        		workFrame.frames[i].form.set_enableevent(false);
        ...
        */
         ...
         * @description 탭이동 - 앞으로
        */
        this.divButtonList_btnMdiPrev_onclick = function(obj,e)
        {
         ...
         * @description 탭이동 - 뒤로
        */
        this.divButtonList_btnMdiNext_onclick = function(obj,e)
        {
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnMaximize.addEventHandler("onclick",this.btnMaximize_onclick,this);
            this.btnMdiNext.addEventHandler("onclick",this.divButtonList_btnMdiNext_onclick,this);
            this.btnMdiPrev.addEventHandler("onclick",this.divButtonList_btnMdiPrev_onclick,this);
        };
