(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("조회+디테일+그리드(상하)");
            ...
            obj = new Div("div_search","0","0",null,"52","25",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Div00");
            ...
            obj = new Calendar("cal_XXXX","319","10","142","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Edit("edt_XXXX00","765","10","140","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("8");
            obj.set_tooltiptext("edit");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Div("Div00","0","div_search:50",null,"157","25",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static03","0","div_search:0","160","50",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("디테일타이틀");
            ...
            obj = new Static("Static54",null,"52","300","15","0",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("h15");
            ...
            obj = new Static("Static54_00",null,"51","160","50","840",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("h50");
            obj.set_visible("false");
            obj.set_background("rgba(251,123,123,0.47843137254901963)");
            ...
            obj = new Static("Static03_00","0","Div00:0","123","50",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("그리드타이틀2");
            obj.set_cssclass("sta_WF_Subtitle");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01","0","Static03_00:0",null,null,"25","0",null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Div("divGrdBtn",null,"Div00:0","685","50","25",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("div_00");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);
