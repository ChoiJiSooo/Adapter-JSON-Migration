(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("조회+그리드+그리드(좌우)");
            ...
            obj = new Grid("Grid00","0","141",null,null,"555","3",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("da_grd");
            obj.getSetter("useinputpanel").set("false");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"28\"/><Column size=\"212\"/><Column size=\"63\"/><Column size=\"84\"/></Columns><Rows><Row size=\"40\" band=\"head\"/><Row size=\"40\"/><Row size=\"40\" band=\"summ\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"Normal\"/><Cell col=\"2\" text=\"Text\"/><Cell col=\"3\" text=\"Date\"/></Band><Band id=\"body\"><Cell displaytype=\"checkbox\" edittype=\"checkbox\"/><Cell col=\"1\" style=\"align: ;\" text=\"bind:Column2\"/><Cell col=\"2\" displaytype=\"text\" style=\"align: ;\" text=\"bind:Column3\"/><Cell col=\"3\" displaytype=\"date\" edittype=\"date\" style=\"align: ;\" text=\"bind:Column4\"/></Band><Band id=\"summary\"><Cell colspan=\"2\" text=\"합계\"/><Cell col=\"2\" colspan=\"2\" style=\"align:right middle;\" text=\"43,843,145\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01","Grid00:20","141",null,null,"25","3",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_binddataset("da_grd");
            obj.getSetter("useinputpanel").set("false");
            obj.set_autofittype("col");
            ...
            obj = new Static("Static00_00",null,"0","20",null,"535","0",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("w\r\n20");
            obj.set_visible("false");
            obj.set_background("rgba(251,123,123,0.47843137254901963)");
            ...
            obj = new Div("divGrdBtn",null,"91","685","50","25",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("div_00");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);
