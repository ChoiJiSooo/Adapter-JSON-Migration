(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("조회+그리드+그리드(상하)");
            ...
            obj = new Div("divGrdBtn00",null,"Grid00:0","600","50","25",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("div_00");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);

            obj = new Button("btnAddRow","30","15","75","30",null,null,null,null,null,null,this.divGrdBtn00.form);
            obj.set_taborder("3");
            obj.set_text("행추가");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_AddRow");
            this.divGrdBtn00.addChild(obj.name, obj);

            obj = new Button("btnDelRow","111","15","75","30",null,null,null,null,null,null,this.divGrdBtn00.form);
            obj.set_taborder("2");
            obj.set_text("행삭제");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_DelRow");
            ...
            obj = new Button("btnExcelDown","541","15","103","30",null,null,null,null,null,null,this.divGrdBtn00.form);
            obj.set_taborder("0");
            obj.set_text("엑셀업로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelDown");
            ...
            obj = new Button("btnExcelUp","419","15","116","30",null,null,null,null,null,null,this.divGrdBtn00.form);
            obj.set_taborder("1");
            obj.set_text("엑셀다운로드");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_ExcelUp");
            ...
            obj = new Button("btnCustom","588","25","87","30",null,null,null,null,null,null,this.divGrdBtn00.form);
            obj.set_taborder("5");
            obj.set_text("커스텀버튼");
            obj.set_cssclass("btn_WF_Custom");
            obj.set_fittocontents("width");
            ...
            obj = new Button("btnSave","231","17","64","30",null,null,null,null,null,null,this.divGrdBtn00.form);
            obj.set_taborder("4");
            obj.set_text("저장");
            obj.set_fittocontents("width");
            obj.set_cssclass("btn_WF_GrdSave");
            ...
            //-- Default Layout : this.divGrdBtn00.form
            obj = new Layout("default","",0,0,this.divGrdBtn00.form,function(p){});
            obj.set_type("horizontal");
            obj.set_flexcrossaxisalign("center");
            obj.set_flexmainaxisalign("end");
            obj.set_horizontalgap("5");
            obj.set_spacing("15px 0px 5px 0px");
            this.divGrdBtn00.form.addLayout(obj.name, obj);
